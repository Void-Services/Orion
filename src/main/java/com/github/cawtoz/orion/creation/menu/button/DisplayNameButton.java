...
public class DisplayNameButton extends Button {

    private final Creation creation;

    public DisplayNameButton(Creation creation) {
        this.creation = creation;
        setMaterial(Material.PAPER);
        setDisplayName("&5&lDisplay&8: &f" + creation.getDisplayName());
        setLore(
                "",
                "&5    ❱ &dclick &fto edit. &5❰    ",
                ""
    ...
    public void click(Player player, ClickType clickType) {
        ...
        creation.setState(CState.DISPLAY_NAME);
    }
